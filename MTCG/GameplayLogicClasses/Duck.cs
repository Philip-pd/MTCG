...
{
    class Duck : MonsterCard
    {
        public Duck(element _Element, int _Damage, string _Name) : base(_Element, _Damage, _Name) { }
        ...
        {
            if (Enemy.Name == "Wizzard" || Enemy.Name == "Elf" || Enemy.Name == "Knight")
                return true;
            return false;
        }
    }
